            ...
            <div class="col-md-12">
                ...
                <div class="row align-items-end">
                    <div class="col-md-5 mt-2">
                        ...
                        <input type="text" class="form-control" id="validationDefault04" value="<?= $destinasiList[$id][0] ?>" readonly>
                    </div>
                </div>
                <div class="row align-items-end">
                    <div class="row align-items-end">
                        <div class="col-md-2 mt-2">
                            ...
                            <input type="text" class="form-control" id="harga" value="Rp. <?= number_format($destinasiList[$id][2]) ?>" readonly>
                        </div>
                        <div class="col-md-2 mt-2">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="../src/img/produk/<?= $destinasiList[$id][3] ?>" alt="">
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-sm">
